...
<body>
    ...
    //adicionando propiedades/atributos ao objeto
    ...
    <ul>
        ...
        <li>Peso:<?= $usuario->caracteristicas->peso ?></li>
    </ul>
  ...
  ?>
   ...
   <pre> <?php var_dump($arrayPedido) ?></pre>
    ...
    <h3>Analisando a estrutura do array orignal e do objeto gerado</h3>
    <pre>
        <?php var_dump($curso) ?>
    </pre>

    <pre>
        <?php var_dump($objetoCurso) ?>
    </pre>
