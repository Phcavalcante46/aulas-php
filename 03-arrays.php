...
<body>
    ...
    $coisas = ["Ozzy", 2112, "<b>Senac</b>", 253.483, true];
    ...
    <h3>
        Acessando dados de arrays indexados/numéricos
    </h3>
    ...
    <ul>
        ...
        <li>
            Estamos estudando no <?= $coisas[2] ?>
        </li>
        <li>
            Estamos na unidade da cidade <?= FILIAIS[0] ?>
        </li>
    ...
    $curso = [
        ...
        "titulo" => "Gastronomia",
        "carga_horaria" => 800,
        "descricao" => "Aprender a esquetar agua para fazer miojo",
    ...
    <h3>
        Acessando dados de array associativo
    </h3>
    ...
    <h3>
        Acessando dados da matriz de arrays indexados
    </h3>
    <p>Meu foco agora é no <?= $planoDeEstudos[1][0] ?></p>
    <p>O <?= $clientes[0]["nome"] ?> me deve <?= $clientes[0]["me_devendo"] ?></p>

    <h2>
        Funções de ánalise/debug de estruturas de dados (arrays, objetos)
    </h2>
    <?php 
